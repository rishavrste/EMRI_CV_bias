"""IMRI 0PA + PN (2.5PN) deviation, refined with CV from TWO starts.
...
1000-step Nelder-Mead escape then one more CV) is run from BOTH:
    ...
    * start_dev : the earlier NM/DE 0PA+PN-deviation best fit
...
Run:  python gauss_cv_imri_pn_dev.py
"""
...
CASES = [
    dict(name="idx0", dt=5.0, T=1.0, chi2=0.95, nm_dev_overlap=0.996605,
         ...
         start_dev=[1001219.8218, 4979.1598, 0.703966, 24.96823, 0.250478, 0.785123,
                    1.005773, 1.023603, 0.321583, -3.178504, 0.105184]),
    dict(name="idx1", dt=5.0, T=1.0, chi2=0.95, nm_dev_overlap=0.968125,
         ...
         start_dev=[997170.7100, 1001.3713, -0.501641, 25.00501, 0.100624, 1.052885,
                    0.787741, 6.188492, 0.213282, 1.323580, 7.101988]),
    dict(name="idx16", dt=5.0, T=1.0, chi2=0.95, nm_dev_overlap=0.999598,
         ...
         start_dev=[1002141.5021, 1000.1270, -0.492649, 24.64384, 0.399780, 1.049732,
                    0.786328, 0.109052, -5.963450, 3.375175, -0.094908]),
]
