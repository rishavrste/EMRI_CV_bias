"""IMRI-tails 0PA + PN (2.5PN) deviation, refined with CV from TWO starts.
...
1000-step Nelder-Mead escape then one more CV) is run from BOTH:
    ...
    * start_dev : the DE/NM 0PA+PN-deviation best fit
...
Run:  python gauss_cv_imri_tails_pn_dev.py
"""
...
CASES = [
    dict(name="pt4", dt=10.0, T=0.25, chi2=0.95,
         zeropa_overlap=0.999865, nm_dev_overlap=0.994051,
         ...
         start_dev=[1002130.0792, 9997.9950, 0.899973, 29.245505, 0.098243,
                    1.073750, 0.766654, 5.539117, 5.659269, 0.547828, -2.459314]),
    dict(name="pt20", dt=10.0, T=0.25, chi2=0.95,
         zeropa_overlap=0.997869, nm_dev_overlap=0.997866,
         ...
         start_dev=[1012623.7758, 9966.7906, -0.835534, 30.153174, 0.499398,
                    1.043566, 0.784634, 0.173826, 0.238566, 4.115e-06, 1.906e-06]),
]
