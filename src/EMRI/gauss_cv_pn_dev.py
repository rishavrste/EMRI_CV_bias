"""0PA + PN (2.5PN) deviation: CV -> Nelder-Mead(500) -> CV, for all three EMRI cases.

Start at each case's CV-refined 0PA best fit with dev_1 = dev_2 = 0, turn on the two
2.5PN-type deviation coefficients (C_p, C_e -- additive pdot/edot correction), and try
...
PN deviation -> additional_args[5]=C_p=dev_1, [6]=C_e=dev_2  (SuperKludgeFlux).

Run:  python gauss_cv_pn_dev.py
"""
...
def dev_tail(dev_1, dev_2):
    """[C_p, C_e, del_0_p, del_0_e] slice of additional_args for the PN (2.5PN) deviation."""
...
CASES = [
    dict(name="idx0", dt=5.0, T=1.0, chi2=0.0, dev_nm_overlap=0.9986067657080662,
    ...
    dict(name="idx9", dt=10.0, T=2.5, chi2=0.95, dev_nm_overlap=0.9995428908954582,
    ...
    dict(name="idx13", dt=10.0, T=2.5, chi2=0.95, dev_nm_overlap=0.9998995470850759,
